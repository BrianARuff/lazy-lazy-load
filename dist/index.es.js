import react, { createContext, forwardRef, createElement, Component, Fragment, lazy, Suspense } from 'react';
...
var ClipLoader = createCommonjsModule(function (module, exports) {
...
var clip = core_esm.keyframes(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  0% {transform: rotate(0deg) scale(1)}\n  50% {transform: rotate(180deg) scale(0.8)}\n  100% {transform: rotate(360deg) scale(1)}\n"], ["\n  0% {transform: rotate(0deg) scale(1)}\n  50% {transform: rotate(180deg) scale(0.8)}\n  100% {transform: rotate(360deg) scale(1)}\n"])));
var Loader = /** @class */ (function (_super) {
    ...
    function Loader() {
        ...
        _this.style = function () {
            ...
            return core_esm.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      background: transparent !important;\n      width: ", ";\n      height: ", ";\n      border-radius: 100%;\n      border: 2px solid;\n      border-color: ", ";\n      border-bottom-color: transparent;\n      display: inline-block;\n      animation: ", " 0.75s 0s infinite linear;\n      animation-fill-mode: both;\n    "], ["\n      background: transparent !important;\n      width: ", ";\n      height: ", ";\n      border-radius: 100%;\n      border: 2px solid;\n      border-color: ", ";\n      border-bottom-color: transparent;\n      display: inline-block;\n      animation: ", " 0.75s 0s infinite linear;\n      animation-fill-mode: both;\n    "])), "" + size + sizeUnit, "" + size + sizeUnit, color, clip);
        };
        return _this;
    }
    Loader.prototype.render = function () {
        var _a = this.props, loading = _a.loading, css = _a.css;
        return loading ? core_esm.jsx("div", { css: [this.style(), css] }) : null;
    };
    Loader.defaultProps = proptypes.sizeDefaults(35);
    return Loader;
}(React.PureComponent));
...
var ClipLoader$1 = unwrapExports(ClipLoader);

function LazyComponent() {
  var pathToComponent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var fallbackComponent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : React.createElement(ClipLoader$1, null);
